...
Credits are automatically deducted from a customer's invoice balance (after tax) at invoice generation time. Additionally, you can manually draw down or void a customer's credit balance if necessary.
