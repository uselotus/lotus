...
Lotus is built to enable the management of packaging as well as pricing
...
information about what features a customer currently has access to.

By storing the feature and usage entitlements of each customer in Lotus, you are now free
...
([guide](/api-reference/customers/get-customer-access)).
