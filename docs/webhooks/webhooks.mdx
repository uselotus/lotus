...
You can create webhooks from the Developer Settings tab of the Settings page. After creating a webhook, you will be able to see the following information, including the webhook secret, which is used for verifying the authenticity of the request.
