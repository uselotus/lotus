# Generated by Django 4.0.5 on 2022-11-13 03:38
...
def migrate_plancomponetns_to_price_tiers(apps, schema_editor):
    ...
    PriceTier = apps.get_model("PriceTier", "PriceTier")
        ...
        for pc in pv.components.all():
            ...
            if pc.free_metric_units and pc.free_metric_units > 0:
                PriceTier.objects.create(
                    ...
                    metric_units=pc.free_metric_units,
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("metering_billing", "0073_plancomponent_plan_version_pricetier"),
    ]
