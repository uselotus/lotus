# Generated by Django 4.0.5 on 2022-11-01 19:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='invoice_id',
            field=models.CharField(blank=True, db_index=True, default=uuid.uuid4, max_length=100),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('monthly', 'Monthly'), ('quarterly', 'Quarterly'), ('yearly', 'Yearly')], max_length=40, null=True),
        ),
        migrations.AlterField(
            model_name='historicalsubscription',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=10, max_digits=20)),
                ('description', models.TextField(blank=True, null=True)),
                ('created', models.DateTimeField(default=metering_billing.utils.utils.now_utc)),
                ('effective_at', models.DateTimeField(default=metering_billing.utils.utils.now_utc)),
                ('expires_at', models.DateTimeField(blank=True, null=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_balance_adjustments', to='metering_billing.customer')),
            ],
            options={
