# Generated by Django 4.0.5 on 2023-01-11 00:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('metering_billing', '0146_usagealert_alter_webhooktrigger_trigger_name_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='tag',
            name='organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='metering_billing.organization'),
        ),
        migrations.AddField(
            model_name='plan',
            name='tags',
